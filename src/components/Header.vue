<template>
  ...
  <div class="container">
    <router-link class="navbar-brand" to="/"><img alt="Vue logo" class="logo" src="@/assets/logo.png"></router-link>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul id="nav" class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <router-link class="nav-link active" to="/Add" v-if="$store.state.isAuthenticated">Add</router-link>
        </li>
        <li class="nav-item">
